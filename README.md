...
- 编译产物会上传到本次 workflow 的 `Artifacts`，并以 `x86-64-*.apk`、`aarch64-*.apk` 这类带架构前缀、文件名已将 `~` 规范化为 `-` 的原始软件包发布到 `Packages` 这个 [Releases](https://github.com/laipeng668/openwrt-ci-roc/releases/tag/Packages)。
