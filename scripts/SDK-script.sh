...
generate_artifact_filters() {
  ...
  selection_in nginx && config_package_enabled nginx-ssl-util && add_artifact_package nginx-ssl-util
...
copy_artifacts() {
  ...
  while IFS= read -r -d '' package_file; do
    ...
    target_file="$OUTPUT_DIR/$PACKAGE_ARCH_NAME-$safe_package_name"
